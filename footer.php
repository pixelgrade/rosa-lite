...
if ( ! is_404() ):
	$footer_sidebar_style = 'sidebar--footer__' . rosa::option( 'footer_sidebar_style' );
	$footer_bottom_bar_style = 'copyright-area__' . rosa::option( 'footer_bottombar_style' ); ?>
		...
		<div class="copyright-area <?php echo $footer_bottom_bar_style ?>">
			...
			<div class="container">
				<div class="footer-container">
					<?php $copyright_text = rosa::option( 'copyright_text' );
					if ( ! empty( $copyright_text ) ) : ?>
						<div class="copyright-text">
							<?php echo rosa::option( 'copyright_text' ) ?>
						</div>
					<?php endif;
