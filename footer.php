...
if ( ! is_404() ) {
	...
	<footer data-bully class="site-footer <?php echo true === $footer_needs_big_waves ? 'border-waves' : '' ?>">
...
get_template_part( 'template-parts/svg/border-wave-svg' ); ?>
