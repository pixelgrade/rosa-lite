...
<p class="cmb_metabox_description">If 0 it will stretch to each image height.</p>', wpgrade::textdomain() ),
		...
		wpgrade::shortname() . '_homepage_chooser' => array(
			...
			'title'      => __( 'Configure Your Google Map', wpgrade::textdomain() ),
			'pages'      => array( 'page' ), // Post type
			'context'    => 'normal',
			'priority'   => 'high',
			'hidden'     => true,
			...
			'fields'     => array(
				array(
					'name' => __( 'Google Maps URL', wpgrade::textdomain() ),
					'desc' => __( 'Please paste here the Share URL you have taken from www.google.com/maps.', wpgrade::textdomain() ),
				...
				array(
					'name'    => __( 'Marker Content', wpgrade::textdomain() ),
					'desc'    => __( 'Insert here the content of the location marker - leave empty for no custom marker.', wpgrade::textdomain() ),
