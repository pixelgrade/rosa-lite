			...
			<div class="form-container">
				...
				<div class="protected-area-text">
					...
					if ( $wpgrade_private_post['error'] ) {
						...
						<span
							class="gray"><?php _e( 'Please enter your password again.', wpgrade::textdomain() ); ?></span>
					<?php } else { ?>
						<span
							class="gray"><?php _e( 'Please enter your password to continue.', wpgrade::textdomain() ); ?></span>
					<?php } ?>
				...
				<form class="auth-form" method="post"
					...
					<input type="password" name="post_password" id="auth_password" class="auth__pass"
						placeholder="<?php _e( "Password", wpgrade::textdomain() ) ?>"/>
					<input type="submit" name="Submit" id="auth_submit" class="auth__submit  btn"
						value="<?php _e( "Authenticate", wpgrade::textdomain() ) ?>"/>
				</form>
			</div>
		</div>
	</div>
