	...
	$.fn.avgrund = function (a) {
		...
		return a = $.extend(b, a), this.each(function () {
			...
			function d() {
				...
				}, 100), g.append('<div class="avgrund-popin ' + a.holderClass + '">' + j + "</div>"), $(".avgrund-popin").css({
					width: h + "px",
					height: i + "px",
			...
			var f = $(this), g = $("body"), h = a.width > 640 ? 640 : a.width, i = a.height > 350 ? 350 : a.height, j = "function" == typeof a.template ? a.template(f) : a.template instanceof jQuery ? a.template.html() : a.template;
			g.addClass("avgrund-ready"), g.append('<div class="avgrund-overlay ' + a.overlayClass + '"></div>'), "" !== a.onBlurContainer && $(a.onBlurContainer).addClass("avgrund-blur"), a.openOnEvent ? f.bind(a.setEvent, function (a) {
