...
//			parent::__construct( $parent->sections, $parent->args );
			...
			*/
			...
			add_action( 'customize_controls_enqueue_scripts', array( $parent, '_enqueue' ), 0); // Customizer control scripts
...
//			wpgrade::g
		...
		public function js_customizer_enqueue() {
			...
			wp_enqueue_script(
				'redux-theme_customizer',
				wpgrade::coremoduleuri('redux3') .'extensions/customizer/assets/js/theme_customizer.js',
		...
		public function js_customizer_live_preview_enqueue()
		{
			wp_register_script(
				'CSSOM',
				wpgrade::coremoduleuri('redux3') .'extensions/customizer/assets/js/CSSOM.js',
				array( 'jquery' ),
				'',
				true //Put script in footer?
			);
			wp_register_script(
				'cssUpdate',
				wpgrade::coremoduleuri('redux3') .'extensions/customizer/assets/js/jquery.cssUpdate.js',
				array( 'jquery' ),
				'',
				true //Put script in footer?
			);
			wp_enqueue_script(
				'redux-theme_customizer_preview',
				wpgrade::coremoduleuri('redux3') .'extensions/customizer/assets/js/theme_customizer_preview.js',
				array( 'jquery','customize-preview', 'CSSOM', 'cssUpdate' ),
				'',
				true //Put script in footer?
			);
		...
		public function header_output() {
			...
			if ( !isset( $GLOBALS['wp_customize'] ) ) return ;
			...
			foreach( $this->parent->sections as $key => $section ) {
				...
				foreach( $section['fields'] as $skey => $option ) {
					...
					if ( !isset($option['customizer']) || !is_array( $option['customizer'] )) continue;
